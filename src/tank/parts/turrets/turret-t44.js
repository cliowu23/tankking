...
const PAINT = {
  ...
  // Fittings stay metal, not painted red:
  //   Object_20 = AA MG mount base, Object_3 = MG cradle, Object_9 = bracket,
  //   Object_2 = antenna, Object_13 = rolled tarp on the turret rear.
  paintSkipMeshes: ['Object_2', 'Object_3', 'Object_9', 'Object_13', 'Object_20'],
};
